...
module.exports = {
  content: [
    ...
    // Agregar rutas adicionales si tienes componentes en otras carpetas
  ...
  plugins: [],
  // Configuración importante para purgar CSS correctamente
  safelist: [
    ...
    {
      pattern: /border-(red|green|blue|yellow|purple|pink|indigo)-(50|100|200|300|400|500|600|700|800|900)/,
    },
  ],
};
